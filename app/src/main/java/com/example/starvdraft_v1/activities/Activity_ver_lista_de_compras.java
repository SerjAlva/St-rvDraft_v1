...
import com.example.starvdraft_v1.adapters.CategoriaAdapter;
import com.example.starvdraft_v1.models.CategoriaAlimento;
import com.example.starvdraft_v1.models.ElementosLista;
...
public class Activity_ver_lista_de_compras extends AppCompatActivity {
    ...
    ImageView ivComprar, ivAñadir, ivTuCarritoStarv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivTuCarritoStarv = findViewById(R.id.carritoButton);
        ...
        ivTuCarritoStarv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                home();
            }
    ...
    public void home(){
        Intent intent = new Intent(Activity_ver_lista_de_compras.this, HomeActivity.class);
