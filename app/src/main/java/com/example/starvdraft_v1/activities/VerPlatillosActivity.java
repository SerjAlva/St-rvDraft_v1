...
import com.example.starvdraft_v1.adapters.AdaptadorPlatillo;
import com.example.starvdraft_v1.models.ItemCarrito;

import java.util.ArrayList;
import java.util.List;

public class VerPlatillosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_platillos);
        ...
        adaptadorPlatillo.setOnItemClickListener(new AdaptadorPlatillo.OnItemClickListener() {
            ...
            public void onRetirePortionClick(int position) {
                ...
                if(lista.get(position).porciones == 1){
                    Toast.makeText(VerPlatillosActivity.this, "No se pueden retirar porciones", Toast.LENGTH_SHORT).show();
                }else{
                    lista.get(position).porciones--;
                    lista.get(position).precioMostrador = lista.get(position).precio*lista.get(position).porciones;
                    actualizarPrecio(-(lista.get(position).precio));
            ...
            public void onRemoveClick(final int position) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(VerPlatillosActivity.this);
                ...
                try {
                    ...
                    Toast.makeText(VerPlatillosActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnComprar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(VerPlatillosActivity.this, "Reordenando Datos", Toast.LENGTH_SHORT).show();
                /*lista = cargarDatos();
                ...
                Intent intent = new Intent(VerPlatillosActivity.this, Activity_ver_lista_de_compras.class)
